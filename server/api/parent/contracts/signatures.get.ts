...
import { findContractChildById, listContractSignerStatuses, listContractSignatures } from '~/server/utils/parent-contracts'
...
export default defineEventHandler((event) => {
  ...
  return {
    signers: listContractSignerStatuses(childId),
    log: listContractSignatures(childId)
  }
})
